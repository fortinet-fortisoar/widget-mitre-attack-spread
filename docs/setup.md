...
2. From the list of widget that appears, search for **MITRE ATT&CK Alert Case Spread Widget**.
3. Click the **MITRE ATT&CK Alert Case Spread Widget** widget card.
4. Click **Install** on the lower part of the screen to begin installation.

# Prerequisites

Following are the prerequisites to using the **MITRE ATT&CK Alert Case Spread** widget:
...
Specify following details to customize the **MITRE ATT&CK Alert Case Spread** widget to suit your requirements:

| Fields                       | Description                                                                                                                       |
|------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| Title                        | Specify the optional custom heading or a title for the widget.                                                                    |
| Show Alert and Case Coverage | An optional toggle to highlight and expand Techniques and Subtechniques with linked alerts and cases.                             |
